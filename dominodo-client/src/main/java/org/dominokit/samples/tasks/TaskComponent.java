...
import org.dominokit.domino.ui.shaded.typography.Paragraph;
...
import org.dominokit.domino.ui.shaded.cards.HeaderAction;
import org.dominokit.domino.ui.shaded.datepicker.DatePicker;
import org.dominokit.domino.ui.shaded.dialogs.ConfirmationDialog;
import org.dominokit.domino.ui.shaded.dropdown.DropDownMenu;
import org.dominokit.domino.ui.shaded.dropdown.DropDownPosition;
...
import org.dominokit.domino.ui.shaded.notifications.Notification;
import org.dominokit.domino.ui.shaded.popover.Popover;
import org.dominokit.domino.ui.shaded.popover.PopupPosition;
...
import org.dominokit.domino.ui.shaded.utils.ScreenMedia;
...
//                .appendDescriptionChild(dueDateElement)
                ...
                .apply(self -> self.getHeader().insertAfter(dueDateElement.element(), self.getHeaderBar().element()))
    ...
    private HeaderAction getStatusAction(Task task) {
        if (task.isActive()) {
            return HeaderAction.create(Icons.ALL.check_all_mdi()
                    .setColor(Color.GREEN)
                    .setTooltip("Resolve")
                    .hideOn(ScreenMedia.SMALL_AND_DOWN)
                    .addClickListener(evt -> resolve()));
        } else {
            return HeaderAction.create(Icons.ALL.replay_mdi()
